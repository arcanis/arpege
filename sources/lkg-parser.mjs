...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
    ...
    peg$c19 = function (expression, value0) {
      return value0;
    },
    ...
    peg$c28 = function (operator, expression) {
      return {
    ...
    peg$c35 = function (expression, operator) {
      return {
    ...
    peg$c100 = function (name, parameters) {
      return parameters;
    },
    peg$c101 = function (name, parameters) {
      return {
        name,
    ...
    peg$c104 = function (parameterList) {
      return Object.fromEntries(parameterList);
    },
    peg$c105 = function (name) {
      return name === `expr` || name.endsWith(`Expr`);
    },
    peg$c106 = function (name, expression) {
    ...
    peg$c110 = function (value, ignoreCase) {
      return {
        type: `literal`,
        location: location(),
    ...
    peg$c113 = peg$otherExpectation("array"),
    peg$c114 = "[",
    ...
    peg$c129 = peg$otherExpectation("s(v)b"),
    peg$c130 = peg$otherExpectation("regexp"),
    peg$c131 = function (inverted, parts, ignoreCase) {
      return {
        type: `class`,
        location: location(),
    ...
    peg$c204 = "break",
    peg$c205 = peg$literalExpectation("break", false),
    peg$c206 = "case",
    peg$c207 = peg$literalExpectation("case", false),
    peg$c208 = "catch",
    peg$c209 = peg$literalExpectation("catch", false),
    peg$c210 = "class",
    peg$c211 = peg$literalExpectation("class", false),
    peg$c212 = "const",
    peg$c213 = peg$literalExpectation("const", false),
    peg$c214 = "continue",
    peg$c215 = peg$literalExpectation("continue", false),
    peg$c216 = "debugger",
    peg$c217 = peg$literalExpectation("debugger", false),
    peg$c218 = "default",
    peg$c219 = peg$literalExpectation("default", false),
    peg$c220 = "delete",
    peg$c221 = peg$literalExpectation("delete", false),
    peg$c222 = "do",
    peg$c223 = peg$literalExpectation("do", false),
    peg$c224 = "else",
    peg$c225 = peg$literalExpectation("else", false),
    peg$c226 = "enum",
    peg$c227 = peg$literalExpectation("enum", false),
    peg$c228 = "export",
    peg$c229 = peg$literalExpectation("export", false),
    peg$c230 = "extends",
    peg$c231 = peg$literalExpectation("extends", false),
    peg$c232 = "false",
    peg$c233 = peg$literalExpectation("false", false),
    peg$c234 = "finally",
    peg$c235 = peg$literalExpectation("finally", false),
    peg$c236 = "for",
    peg$c237 = peg$literalExpectation("for", false),
    peg$c238 = "function",
    peg$c239 = peg$literalExpectation("function", false),
    peg$c240 = "if",
    peg$c241 = peg$literalExpectation("if", false),
    peg$c242 = "import",
    peg$c243 = peg$literalExpectation("import", false),
    peg$c244 = "instanceof",
    peg$c245 = peg$literalExpectation("instanceof", false),
    peg$c246 = "in",
    peg$c247 = peg$literalExpectation("in", false),
    peg$c248 = "new",
    peg$c249 = peg$literalExpectation("new", false),
    peg$c250 = "null",
    peg$c251 = peg$literalExpectation("null", false),
    peg$c252 = "return",
    peg$c253 = peg$literalExpectation("return", false),
    peg$c254 = "super",
    peg$c255 = peg$literalExpectation("super", false),
    peg$c256 = "switch",
    peg$c257 = peg$literalExpectation("switch", false),
    peg$c258 = "this",
    ...
    peg$c264 = "try",
    peg$c265 = peg$literalExpectation("try", false),
    peg$c266 = "typeof",
    peg$c267 = peg$literalExpectation("typeof", false),
    peg$c268 = "var",
    peg$c269 = peg$literalExpectation("var", false),
    peg$c270 = "void",
    peg$c271 = peg$literalExpectation("void", false),
    peg$c272 = "while",
    peg$c273 = peg$literalExpectation("while", false),
    peg$c274 = "with",
    peg$c275 = peg$literalExpectation("with", false),
    peg$c276 = ";",
  ...
  function peg$parseExpression() {
    ...
    if (s1 !== peg$FAILED) {
      s2 = peg$parse__();
      if (s2 !== peg$FAILED) {
        s3 = peg$parseLeadingChoiceExpression();
        if (s3 !== peg$FAILED) {
          peg$savedPos = s0;
          s1 = peg$c11(s1, s3);
          s0 = s1;
  ...
  function peg$parseGenericAnnotation() {
    var s0, s1, s2, s3, s4, s5;
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s3 !== peg$FAILED) {
        peg$transactions.unshift([]);
        s4 = peg$parseAnnotationParameters();
        if (s4 !== peg$FAILED) {
          peg$currentTransaction = peg$transactions.shift();
          if (peg$transactions.length > 0) {
            peg$transactions[0].unshift(...peg$currentTransaction);
